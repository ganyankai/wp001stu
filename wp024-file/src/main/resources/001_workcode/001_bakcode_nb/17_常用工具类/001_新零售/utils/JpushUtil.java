...
public class JpushUtil {
    protected static final String APP_KEY ="f917ff0a382b306fc743e2cd";
    protected static final String MASTER_SECRET = "7d9f4fc34755829e89d59858";
    ...
    public static void jpush(String tag,String tilte,String content) {
        ...
        PushPayload payload = PushPayload.newBuilder()
                ...
                .build();
            log.error("bbbbbbbbbbbbbbbbbbbbbb");
            PushResult pushResult = jpushClient.sendPush(payload);
            log.error("cccccccccccccccccccccccc");
        } catch (Exception e) {
            log.error("捕获tag");
